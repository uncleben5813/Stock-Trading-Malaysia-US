...
async function candles(symbol, interval = "1d") {
  ...
  try {
    ...
    console.warn("Market API:", symbol, e);
...
/* =========================
   ANALYZE RADAR COUNTER
========================= */

async function analyze(item) {

  const c =
    await candles(item.symbol);
...
async function analyzeAll(list) {
  ...
  /*
    Batch 5 supaya tak bombard API.
  */
...
function sectorName(item) {

  /*
    Radar Yahoo tak semestinya
    pulangkan sector.

    Kita map berdasarkan nama
    untuk universe yang kita kenal.
  */
  ...
  const map = {
    ...
    "4863.KL":"Telecommunications",
    "6012.KL":"Telecommunications",
    "6947.KL":"Telecommunications",

    "3042.KL":"Utilities",
    "7089.KL":"Utilities",
    "4677.KL":"Utilities",

    "5183.KL":"Consumer Fuels",
    "5681.KL":"Chemicals",

    "5347.KL":"Construction",
    "5398.KL":"Construction",
    "5211.KL":"Construction",

    "4197.KL":"Plantation",
    "1961.KL":"Plantation",
    "2445.KL":"Plantation",

    "8869.KL":"Oil & Gas Services",
    "3816.KL":"Marine Transport",
    ...
    "5225.KL":"Healthcare",
    "7153.KL":"Rubber Products",
    "7113.KL":"Rubber Products",
    "7086.KL":"Healthcare Equipment",

    "0166.KL":"Semiconductors",
    "0097.KL":"Semiconductors",
...
function renderSectors(id, sectors) {
  ...
  if (!sectors.length) {
    ...
    el.innerHTML =
      `<div class="muted">No market data.</div>`;
...
function renderFocus(focus) {
  ...
  if (!focus.length) {
    ...
    el.innerHTML =
      `<div class="muted">No counters available.</div>`;
            ...
            <b>
              ${
                Number(x.marketCap || 0)
                  ? Number(x.marketCap).toLocaleString()
                  : "—"
              }
            </b>
          </div>
